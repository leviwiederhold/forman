  ...
  return (
    <main className="mx-auto max-w-3xl space-y-6 p-6">
      <div className="space-y-2">
        <div className="text-sm text-foreground/70">Subscribe</div>
      ...
      <div className="rounded-xl border p-6 space-y-3">
        <div className="text-3xl font-semibold">$49<span className="text-base font-normal text-foreground/70">/mo</span></div>
